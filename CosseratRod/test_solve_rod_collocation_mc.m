...
p_0 = zeros(3,1);
R_0 = eye(3);
N = 30; % Num collocation points, number of conditions is 3*N
M = 10; % Dimension of spline spaces, number of variables is 3*M
s_span = [0, 1];
...
[p, q, p_cov, q_cov] = solve_rod_collocation_mc(f, f_cov, l, l_cov, K, N, M, L, p_0, R_0);
