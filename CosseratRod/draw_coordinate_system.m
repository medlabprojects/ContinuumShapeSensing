...
if nargin==5, %add text labels
   x_label_pos= x_cone_origin + 1.2*cone_height*x_axis/axis_length; %using unit vector 
   y_label_pos= y_cone_origin + 1.2*cone_height*y_axis/axis_length;
   z_label_pos= z_cone_origin + 1.2*cone_height*z_axis/axis_length;
